      ...
      <div className=" flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5  w-full">
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          <input
            ...
            placeholder={`Hey ${user.userName}! Add more Stories to this Pin`}
          ...
          <div className="flex flex-col">
            <div>
              <p className="mb-2 font-semibold text:lg sm:text-xl">Add a Category</p>
              <select
                onChange={(e) => {
              ...
              >
                <option value="others" className="sm:text-bg bg-white">Select a Category</option>
                {categories.map((item) => (
